        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Item = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    Key = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: false),
                    Value = table.Column<string>(type: "nvarchar(768)", maxLength: 768, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RowVersion = table.Column<DateTime>(type: "datetime2", rowVersion: true, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    UniqueCode = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Password = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: true),
                    NameModel = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: true),
                    JsonModel = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: true),
                    DictionaryModel = table.Column<string>(type: "nvarchar(127)", maxLength: 127, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Root = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
