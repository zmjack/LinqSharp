...
namespace LinqSharp
{
    public static partial class IEnumerableExtensions
    {
        ...
        /// <returns></returns>
        public static IEnumerablePage<TSource> Page<TSource>(this IEnumerable<TSource> @this, int pageNumber, int pageSize)
        {
            return new EnumerablePage<TSource>(@this, pageNumber, pageSize);
        }
        ...
        public static IEnumerablePage<TSource> SelectPage<TSource>(this IEnumerable<TSource> @this, int pageNumber, int pageSize)
        {
            return new EnumerablePage<TSource>(@this, pageNumber, pageSize);
        }
