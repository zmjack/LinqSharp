    ...
    internal static class OracleFuncProvider
    {
        ...
        private static void Random(ModelBuilder modelBuilder)
        {
            modelBuilder
                ...
                .HasTranslation(args => Translator.Function<double>("DBMS_RANDOM", "RANDOM", args));
        }
        ...
        private static void Concat(ModelBuilder modelBuilder)
        {
            for (int n = 2; n <= 8; n++)
            {
                ...
                modelBuilder
                    ...
                    .HasTranslation(args => args.Aggregate((a, b) => Translator.Function<string>("CONCAT", new[] { a, b })));
            }
        }
