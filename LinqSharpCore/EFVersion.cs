...
namespace LinqSharp
{
    public static class EFVersion
    {
        ...
        public static bool GreaterThan(int major, int minor, int build) => Version >= new Version(major, minor, build);
        public static bool GreaterThan(int major, int minor, int build, int revision) => Version >= new Version(major, minor, build, revision);
